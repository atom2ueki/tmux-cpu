...
print_icon() {
  ...
  if [ "$cpu_percentage" -ge 95 ]; then
    echo "$tier8_icon"
  elif [ "$cpu_percentage" -ge 80 ]; then
    echo "$tier7_icon"
  elif [ "$cpu_percentage" -ge 65 ]; then
    echo "$tier6_icon"
  elif [ "$cpu_percentage" -ge 50 ]; then
    echo "$tier5_icon"
  elif [ "$cpu_percentage" -ge 35 ]; then
    echo "$tier4_icon"
  elif [ "$cpu_percentage" -ge 20 ]; then
    echo "$tier3_icon"
  elif [ "$cpu_percentage" -ge 5 ]; then
    echo "$tier2_icon"
  else
    echo "$tier1_icon"
  fi
